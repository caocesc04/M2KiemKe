            ...
            <div class="row">
                <div class="form-group col-xs-12">
                    ...
                    <div class="col-xs-4" style="background-color: #fff !important;border:none">
                        ...
                        <select class="form-control m-b chosen-select" name="Kho" id="Kho" style="border-radius: 10px;">
                ...
                <div class="form-group col-xs-12" >
                    <div class="col-xs-3">
                        <button type="submit" name="btn" class="btn btn-success kiemkecuahang" data-style="zoom-in" style=""> Lấy dữ liệu</button>
                    </div>
                </div>
            </div>
        </div>
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5 style="color: red">Danh sách kiểm kê theo kho hàng</h5>
                    </div>
