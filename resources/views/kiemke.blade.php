            ...
            <div class="row">
                ...
                <div class="form-group">
                    <div class="col-xs-3" style="margin-top: 5px">
                        <button type="submit" class="btn btn-success kiemkehethong" data-style="zoom-in" style=""> Lấy dữ liệu</button>
                    </div>
                </div>
            </div>
        </div>
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5 style="color: red">Danh sách kiểm kê toàn hệ thống</h5>
                    </div>
